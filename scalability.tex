...
in the Blockchain, that however is still used to secure them. The advantages of
this transactions are the higher throughput (transactions are recorded
...
essentially form a separate network plane: reference \cite{croman-scaling-blockchain}
pointed out that this network can act as a bottleneck as well. 
